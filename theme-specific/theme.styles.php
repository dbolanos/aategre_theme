...
if (!function_exists('saveo_customizer_get_css')) {

	function saveo_customizer_get_css($colors=null, $fonts=null, $remove_spaces=true, $only_scheme='') {
		...
		if ($fonts) {
			...
			$fonts = saveo_customizer_add_theme_fonts($fonts);
...
.saveo_tabs .saveo_tabs_titles li a {
...
.sidebar .sidebar_inner .widget.widget_categories a,
.post-body .post-date,
...
CSS;
			$rez = apply_filters('saveo_filter_get_css', $rez, false, $fonts, '');
			$css['fonts'] = $rez['fonts'];
...
CSS;
		...
		//--------------------------------------
		if ($colors !== false) {
			$schemes = empty($only_scheme) ? array_keys(saveo_get_list_schemes()) : array($only_scheme);
	
			if (count($schemes) > 0) {
				$rez = array();
				foreach ($schemes as $scheme) {
					// Prepare colors
					if (empty($only_scheme)) $colors = saveo_get_scheme_colors($scheme);
...
.sticky.post_item.post_layout_excerpt .post_header .post_date {
    background-color: {$colors['bg_color']};
}
.sticky .post-body .post_meta_item.post_date a {
    color: {$colors['text_link']};
}
.sticky .post-body .post_meta_item.post_date a:hover {
    color: {$colors['text_hover']};
}
/* Page */
#page_preloader,
...
.saveo_tabs .saveo_tabs_titles li a:hover {
	color: {$colors['inverse_link']};
	background-color: {$colors['text_link']};
}
div.esg-filter-wrapper .esg-filterbutton.selected > span,
.saveo_tabs .saveo_tabs_titles li.ui-state-active a {
	color: {$colors['bg_color']};
	background-color: {$colors['text_dark']};
}
...
.post_item_single .post_content .single-meta a:hover {
    color: {$colors['text_hover']};
}
...
.scheme_self.sidebar .sidebar_inner .widget.widget_categories {
    background-color: {$colors['text_link']};
}
.scheme_self.sidebar .sidebar_inner .widget.widget_categories .widget_title{
    color: {$colors['inverse_link']};
}
.scheme_self.sidebar .sidebar_inner .widget.widget_categories a {
    color: {$colors['inverse_link']};
}
.scheme_self.sidebar .sidebar_inner .widget.widget_categories a:hover {
    color: {$colors['inverse_link_07']};
}
/* Widgets */
.widget ul > li:before {
...
.scheme_self .sidebar .widget_recent_comments li > a {
    color: {$colors['text_dark']};
}
.scheme_self .sidebar .widget_recent_comments li > a:hover {
    color: {$colors['text_link']};
}
/* Archive */
...
.scheme_self.sidebar .widget_calendar td#today a:after {
	background-color: {$colors['inverse_link']};
}
.scheme_self.sidebar .widget_calendar td#today a:hover:after {
	background-color: {$colors['inverse_hover']};
}
...
.scheme_dark h1 a:hover, .scheme_dark h2 a:hover, .scheme_dark h3 a:hover, .scheme_dark h4 a:hover, .scheme_dark h6 a:hover, .scheme_dark li a:hover {
...
.post-full .post_header .post_date,
.post_item.post_layout_excerpt .post_header .post_date {
    background-color: {$colors['text_link']};
    color: {$colors['bg_color']};
}
...
.post-body .post_meta_item.post_date a {
    color: {$colors['bg_color']};
}
.post-body .post_meta_item.post_date a:hover {
    color: {$colors['bg_color_07']};
}
.post_featured.hover_icon .mask {
    background-color: {$colors['text_link_06']};
}
.post_info .post_info_item a {
    color: {$colors['text_light']};
}
...
.page-id-112 a[href^="tel:"], 
.page-id-112 a[href^="mailto:"] {
	color: {$colors['bg_color']}!important;
}

.page-id-112 a[href^="tel:"]:hover, 
.page-id-112 a[href^="mailto:"]:hover {
	color: {$colors['text_link']};
}
...
CSS;
					...
					$rez = apply_filters('saveo_filter_get_css', $rez, $colors, false, $scheme);
		...
		return apply_filters( 'saveo_filter_prepare_css', $css_str, $remove_spaces );
	}
}
?>