...
?>><?php
	...
	if (!empty($args['image'])) {
        ...
        if ( !empty($args['icon']) ) {
            ?><div class="promo_mask"></div><div class="sc_promo_icon" data-icon="<?php echo esc_attr($args['icon']); ?>"><?php
            if(!empty($args['icons_link_text'])) echo '<a href="' .esc_attr($args['icons_link_text']) . '">';
            ?><span class="<?php echo esc_attr($args['icon']); ?>"></span><?php
            if(!empty($args['icons_link_text'])) echo '</a>';
            ?></div><?php
        }
        ?></div><?php
	}
