...
if ( !function_exists( 'saveo_woocommerce_get_css' ) ) {
	add_filter( 'saveo_filter_get_css', 'saveo_woocommerce_get_css', 10, 4 );
	function saveo_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.saveo_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.saveo_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
