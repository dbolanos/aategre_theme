...
if (!function_exists('saveo_trx_addons_get_css')) {
	add_filter('saveo_filter_get_css', 'saveo_trx_addons_get_css', 10, 4);
	function saveo_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.footer_wrap .sc_layouts_row_type_narrow a {
    color: {$colors['text_dark']};
}
.footer_wrap .sc_layouts_row_type_narrow a:hover {
